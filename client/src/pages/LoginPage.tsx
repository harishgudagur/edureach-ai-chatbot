    ...
    <div className="absolute inset-0 bg-maroon/60 flex items-center justify-center">
      ...
      <div className="text-center text-white p-8">
        ...
        <p className="text-white/80">
          Your Gateway to Smarter Education
        </p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-maroon focus:ring-1 focus:ring-maroon"
            />
